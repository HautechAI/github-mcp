...
fn handle_tools_call(id: Option<Id>, params: Value) -> Response {
    ...
    match call.name.as_str() {
        ...
        "list_issue_comments" => handle_list_issue_comments(id, args),
        ...
        "list_pr_comments" => handle_list_pr_comments(id, args),
        "list_pr_review_comments" => handle_list_pr_review_comments(id, args),
        "list_pr_review_threads" => handle_list_pr_review_threads(id, args),
        ...
        "list_workflows" => handle_list_workflows(id, args),
        "list_workflow_runs" => handle_list_workflow_runs(id, args),
        "get_workflow_run" => handle_get_workflow_run(id, args),
        "list_workflow_jobs" => handle_list_workflow_jobs(id, args),
        ...
        "list_repo_secrets" => handle_list_repo_secrets(id, args),
        "list_repo_variables" => handle_list_repo_variables(id, args),
        "list_environments" => handle_list_environments(id, args),
        "list_environment_variables" => handle_list_environment_variables(id, args),

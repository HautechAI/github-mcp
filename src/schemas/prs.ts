...
export type GetPullRequestInput = z.infer<typeof GetPullRequestInput>;
export type GetPrStatusSummaryInput = z.infer<typeof GetPrStatusSummaryInput>;
export type ListPrCommentsInput = z.infer<typeof ListPrCommentsInput>;
export type ListPrReviewCommentsInput = z.infer<typeof ListPrReviewCommentsInput>;
export type ListPrReviewsInput = z.infer<typeof ListPrReviewsInput>;
export type ListPrCommitsInput = z.infer<typeof ListPrCommitsInput>;
export type ListPrFilesInput = z.infer<typeof ListPrFilesInput>;
export type GetPrDiffInput = z.infer<typeof GetPrDiffInput>;
export type GetPrPatchInput = z.infer<typeof GetPrPatchInput>;
